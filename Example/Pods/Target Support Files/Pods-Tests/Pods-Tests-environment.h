...
// NDDeviceAPI
#define COCOAPODS_POD_AVAILABLE_NDDeviceAPI
#define COCOAPODS_VERSION_MAJOR_NDDeviceAPI 0
#define COCOAPODS_VERSION_MINOR_NDDeviceAPI 1
#define COCOAPODS_VERSION_PATCH_NDDeviceAPI 0
